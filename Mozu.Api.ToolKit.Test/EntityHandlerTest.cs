...
namespace Mozu.Api.ToolKit.Test
{
    ...
    public class EntityHandlerTest : BaseTest
    {
        ...
        {
            _entityHandler = provider.GetService<IEntityHandler>();
            _entitySchemaHandler = provider.GetService<IEntitySchemaHandler>();
            _appSetting = provider.GetService<IAppSetting>();
            InstallSchema();
        }
